...
namespace axilib
{
    ...
    public:
        ...
        void row(size_type row, const std::vector<T>& vector);

        void col(size_type col, const std::vector<T>& vector);
        ...
        void insert_row(size_type position, const std::vector<T>& vector);

        void insert_rows(size_type position, const Matrix& other);

        void insert_col(size_type position, value_type value = {});

        void insert_col(size_type position, const std::vector<T>& vector);
    ...
    private:
        ...
        void insert_row_impl_(size_type position, const std::vector<T>& vector);

        void insert_rows_impl_(size_type position, const Matrix<T>& other);

        void insert_col_impl_(size_type position, value_type value);

        void insert_col_impl_(size_type position, const std::vector<T>& vector);
