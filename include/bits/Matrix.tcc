...
namespace axilib
{
    ...
    Matrix<T, STORAGE>::row(size_type row)
    {
        ...
        Vector<Row, value_type> vec(begin_row(row), end_row(row));
    ...
    Matrix<T, STORAGE>::col(size_type col)
    {
        ...
        Vector<Col, value_type> vec(begin_col(col), end_col(col));
    ...
    template<typename T, typename STORAGE>
    void
    Matrix<T, STORAGE>::row(size_type row, const Vector<Row, T>& vector)
    {
        #ifdef AXILIB_THROW_EXCEPTIONS
    ...
    template<typename T, typename STORAGE>
    void
    Matrix<T, STORAGE>::col(size_type col, const Vector<Col, T>& vector)
    {
        #ifdef AXILIB_THROW_EXCEPTIONS
    ...
    template<typename T, typename STORAGE>
    void
    Matrix<T, STORAGE>::insert_row(size_type position, const Vector<Row, T>& vector)
    {
    ...
    template<typename T, typename STORAGE>
    void
    Matrix<T, STORAGE>::insert_col(size_type position, const Vector<Col, T>& vector)
    {
    ...
    template<typename T, typename STORAGE>
    void
    Matrix<T, STORAGE>::insert_row_impl_(size_type position, const Vector<Row, T>& vector)
    {
        #ifdef AXILIB_THROW_EXCEPTIONS
            AXILIB_CHECK( (position >= 0) && (position <= rows()), Bad_index("insert_row()", "position = ", "rows size = ", position, rows()))
    ...
    template<typename T, typename STORAGE>
    void
    Matrix<T, STORAGE>::insert_col_impl_(size_type position, const Vector<Col, T>& vector)
    {
        #ifdef AXILIB_THROW_EXCEPTIONS
            AXILIB_CHECK( (position >= 0) && (position <= cols()), Bad_index("insert_col()", "position = ", "cols size = ", position, cols()))
